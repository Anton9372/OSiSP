...
int main(int argc, char* argv[]) {
    ...
    header.numOfRecords = atoi(argv[1]);
    ...
    header.recordsArray = (indexRecord*)malloc(header.numOfRecords * sizeof(indexRecord));
    ...
    if (file == NULL) {
        ...
        fwrite(header.recordsArray, sizeof(indexRecord), header.numOfRecords, file);
    }
